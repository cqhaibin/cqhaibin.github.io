...
require(['require','./app'],function(require, app){ 
    ...
    require(['./layout'],function(layout){
        ...
        var initMenu = function() {
            app.getVue().$store.dispatch('root', {id:'mainc', path: '../modules/test', thridpart: true, name: '业务组件', href: '/mainc', selected: false});
            //app.getVue().$store.dispatch('root', {id:'tomato', path: '../modules/tomato.js', thridpart: true, name: '蕃茄', href: '/tomato', selected: false});
